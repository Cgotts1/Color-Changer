...
Welcome to my HTML, CSS, and JavaScript application! This application consists of 100 squares that will change their color randomly when hovered over or clicked on. 
